...
// enrollment without needing a live meshInstance. Used during leave where
// we don't construct a full instance. (Pre-Phase NN this lived in
// cmd/agent/leave.go alongside the CLI subcommand.)
