...
// SendTestRequest sends a Test message with the given payload to a peer.
// Used by PMTUD to probe path MTU.
...
// SetOnTestReply registers a callback invoked when a TestReply is received.
// Used by PMTUD to detect which probe sizes succeed.
